...
#        if (attrs_metadata["clusterings"][adata_idx]['group']=='Louvain') | (attrs_metadata["clusterings"][adata_idx]['group']=='Leiden'):
#            clusters = attrs_metadata['clusterings'][adata_idx]["clusters"]["id"]
#        else:
